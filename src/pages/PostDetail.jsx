            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l-7-7m7-7H21" />
                    </svg>
                    Back to Feed
                </button>
                ...
                <article className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                    ...
                    <div className="bg-slate-900 px-8 py-16 md:px-16 text-center">
                        <span className="inline-block px-4 py-1.5 bg-indigo-500 text-white text-xs font-black uppercase tracking-[0.2em] rounded-full mb-6">
                            {post.category}
                        </span>
                    ...
                    <div className="px-8 py-12 md:px-20 md:py-16">
                        ...
                        <div className="mt-16 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
                            {user && post.author && user._id === post.author._id ? (
                                <div className="flex items-center gap-4 w-full md:w-auto">
                                    <button
                                        ...
                                        className="flex-grow md:flex-initial px-8 py-3 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 transition shadow-lg shadow-indigo-100 flex items-center justify-center gap-2"
                                    >
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button
                                        ...
                                        className="px-8 py-3 text-red-600 font-bold hover:bg-red-50 rounded-xl transition flex items-center gap-2"
                                    >
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex gap-3">
                                <button className="p-3 rounded-full border border-slate-100 hover:bg-blue-50 hover:text-blue-600 transition">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg>
                                </button>
                                <button className="p-3 rounded-full border border-slate-100 hover:bg-indigo-50 hover:text-indigo-600 transition">
