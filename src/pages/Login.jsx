        ...
        <div className="bg-white min-h-screen py-32">
            <div className="max-w-md mx-auto px-4">
                <div className="text-center mb-16">
                    <span className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 mb-4 block">Access</span>
                    <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase">Sign In</h1>
                </div>
                ...
                <div className="mt-12 text-center">
                    <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mb-4">New here?</p>
                    <Link to="/register" className="text-slate-900 text-xs font-black uppercase tracking-widest hover:underline decoration-2 underline-offset-4">
                        Create Account
                    </Link>
                </div>
            </div>
